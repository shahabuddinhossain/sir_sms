            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-body rounded-0">
                        ...
                        <a href="{{route('enroll-now',['id' => $subject->id])}}" class="btn w-25 mx-auto {{$check == true? 'disabled btn-outline-danger': 'btn-outline-success'}}"> {{$check == true? 'Enrolled': 'Enroll Now'}} </a>
                        <hr/>
