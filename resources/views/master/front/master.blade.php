            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card card-body rounded-0">
                        ...
                        <hr/>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere impedit pariatur temporibus? Aliquid illo in labore laudantium minus pariatur provident quaerat quas reiciendis, voluptate. Debitis illum pariatur praesentium sequi vero.</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card card-body rounded-0">
